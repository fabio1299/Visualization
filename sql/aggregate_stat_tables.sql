...
-- UNION
-- SELECT "SampleID" as subbasini_d ,"Date" as date,"Year" as year,"Month" as month,"Discharge" as discharge,'WBMprist_GPCCv7' as model_name From "WBMprist_GPCCv7"."Discharge_Confluences_monthly"
-- ORDER BY
--     subbasin_id,
--     date
-- ;
...
UNION
SELECT "SampleID" as subbasini_d ,"Date" as date,"Year" as year,"Month" as month,"ZonalMean" as zonal_mean,"ZonalMin" as zonal_min,"ZonalMax" as zonal_max,"ZoneArea" as zone_area,'WBMprist_GPCCv7' as model_name From "WBMprist_GPCCv7"."Evapotranspiration_Confluences_monthly"
ORDER BY
    subbasin_id,
    date
;
...
UNION
SELECT "SampleID" as subbasini_d ,"Date" as date,"Year" as year,"Month" as month,"ZonalMean" as zonal_mean,"ZonalMin" as zonal_min,"ZonalMax" as zonal_max,"ZoneArea" as zone_area,'WBMprist_GPCCv7' as model_name From "WBMprist_GPCCv7"."Precipitation_Confluences_monthly"
ORDER BY
    subbasin_id,
    date
;
...
UNION
SELECT "SampleID" as subbasini_d ,"Date" as date,"Year" as year,"Month" as month,"ZonalMean" as zonal_mean,"ZonalMin" as zonal_min,"ZonalMax" as zonal_max,"ZoneArea" as zone_area,'WBMprist_GPCCv7' as model_name From "WBMprist_GPCCv7"."Runoff_Confluences_monthly"
ORDER BY
    subbasin_id,
    date
;
...
UNION
SELECT "SampleID" as subbasini_d ,"Date" as date,"Year" as year,"Month" as month,"ZonalMean" as zonal_mean,"ZonalMin" as zonal_min,"ZonalMax" as zonal_max,"ZoneArea" as zone_area,'WBMprist_GPCCv7' as model_name From "WBMprist_GPCCv7"."SoilMoisture_Confluences_monthly"
ORDER BY
    subbasin_id,
    date
;
